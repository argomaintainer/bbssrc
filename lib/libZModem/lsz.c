...
int
bbs_zsendfile(char *filename, char *remote)
{
	struct stat f;
...
wctx(struct zm_fileinfo *zi)
{
	...
	while ((firstch = READLINE_PF(Rxtimeout)) != NAK &&
